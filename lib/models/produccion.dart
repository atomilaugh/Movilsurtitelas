...
class ProcesoProduccion extends Equatable {
  ...
  factory ProcesoProduccion.fromJson(Map<String, dynamic> json) {
    return ProcesoProduccion(
      ...
      etapa: EtapaProduccion.values.firstWhere((e) => e.name == json['etapa']),
      estado: EstadoProceso.values.firstWhere((e) => e.name == json['estado']),
  ...
  @override
  List<Object?> get props => [id, pedidoId, etapa, estado, tallerExterno, fechaInicio, fechaFin, responsable];
}

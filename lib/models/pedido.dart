...
class ItemPedido extends Equatable {
  ...
  @override
  List<Object?> get props => [productoId, productoNombre, cantidad, talla, color, precioUnitario, subtotal];
}
...
class Pedido extends Equatable {
  ...
  factory Pedido.fromJson(Map<String, dynamic> json) {
    return Pedido(
      ...
      items: (json['items'] as List).map((i) => ItemPedido.fromJson(i)).toList(),
  ...
  @override
  List<Object?> get props => [id, clienteId, clienteNombre, items, total, abonado, saldo, estado, fechaCreacion, fechaEntregaEstimada, asesorId, asesorNombre, observaciones];
}
